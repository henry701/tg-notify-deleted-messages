...
# TODO: Move to a separate module instead of monkey-patching encrypted_type module
    ...
    def process_result_value(self, value, dialect):
        ...
        if value is not None:
            ...
            try:
                ...
                if isinstance(decrypted_value, type_):
                ...
                # Handle all others, hopefully
                return type_(decrypted_value)
