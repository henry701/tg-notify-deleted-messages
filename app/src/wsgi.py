...
logging.basicConfig(
    level=os.getenv("ROOT_LOGGING_LEVEL", DEFAULT_LOGGING_LEVEL), force=True
)
logging.getLogger("sqlalchemy").setLevel(
    os.getenv("SQLALCHEMY_LOGGING_LEVEL", DEFAULT_LOGGING_LEVEL)
)
logging.getLogger("tgdel-app").setLevel(
    os.getenv("APP_LOGGING_LEVEL", DEFAULT_LOGGING_LEVEL)
)
